...
async function config() {
    ...
    const baseConfig: UserConfig = {
        ...
        head: [
            ["link", {rel: "icon", type: "image/jpg", href: "/Anwesende.jpg",},],
            ['meta', {name: 'referrer', content: 'no-referrer-when-downgrade'}],
            ["meta", {name: "author", content: "Anwesende",},],
            ["meta", {property: "og:title", content: "Home",},],
            ["meta", {property: "og:description", content: "Home of Anwesende",},],
        ],
