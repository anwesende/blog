...
const sport_json: WorkoutRow[] = [
  {
    ...
    "训练部位": "胸",
    "动作名称": "史密斯平板卧推",
    "核心动作要领（含颈椎保护）": "沉肩挺胸，肩胛骨收紧，颈椎中立不抬头；杠铃下到胸中上部，推起不锁肘",
    "关键备注": "大重量优先，最后 2 次吃力",
    "组数": 4,
    "次数（每组建议次数）": "8～12",
    "休息": "直接做 A2"
  },
  {
    ...
    "训练部位": "三头",
    "动作名称": "绳索直杆下压",
    "核心动作要领（含颈椎保护）": "大臂贴身体固定不动，手腕中立不弯；颈椎保持自然中立",
    "关键备注": "只做下压，不做夹胸",
    "组数": 4,
    "次数（每组建议次数）": "12～15",
    "休息": "休 40 秒"
  },
  {
    ...
    "训练部位": "胸",
    "动作名称": "史密斯上斜卧推",
    "核心动作要领（含颈椎保护）": "上斜 30° 左右，沉肩，颈椎不前伸，下落至锁骨下方",
    "关键备注": "侧重上胸",
    "组数": 4,
    "次数（每组建议次数）": "10～12",
    "休息": "直接做 B2"
  },
  {
    ...
    "训练部位": "三头",
    "动作名称": "哑铃颈后臂屈伸",
    "核心动作要领（含颈椎保护）": "大臂垂直地面不动，颈椎中立不歪头；哑铃缓慢下放至头后",
    "关键备注": "单 / 双哑铃均可",
    "组数": 4,
    "次数（每组建议次数）": "10～12",
    "休息": "休 40 秒"
  },
  {
    ...
    "训练部位": "胸",
    "动作名称": "蝴蝶机夹胸",
    "核心动作要领（含颈椎保护）": "座椅高度对齐乳头，沉肩，颈椎中立，胸部持续收紧",
    "关键备注": "蝴蝶机只夹胸",
    "组数": 4,
    "次数（每组建议次数）": "12～15",
    "休息": "直接做 C2"
  },
  {
    ...
    "训练部位": "三头",
    "动作名称": "史密斯窄距卧推",
    "核心动作要领（含颈椎保护）": "握距略窄于肩，肘贴近躯干，颈椎保持中立",
    "关键备注": "三头主导，不塌腰",
    "组数": 4,
    "次数（每组建议次数）": "10～12",
    "休息": "休 40 秒"
  },
  {
    ...
    "训练部位": "胸",
    "动作名称": "哑铃飞鸟",
    "核心动作要领（含颈椎保护）": "仰卧，微屈肘，颈椎中立，下放至胸有牵拉感即可，不超伸",
    "关键备注": "替代绳索夹胸收尾",
    "组数": 3,
    "次数（每组建议次数）": "12～15",
    "休息": "休 40 秒"
  },
  {
    ...
    "训练部位": "背",
    "动作名称": "宽握高位下拉",
    "核心动作要领（含颈椎保护）": "挺胸直背，颈椎中立不仰头，下拉至锁骨上方，不甩腰",
    "关键备注": "龙门架只下拉、划船",
    "组数": 4,
    "次数（每组建议次数）": "10～12",
    "休息": "直接做 A2"
  },
  {
    ...
    "训练部位": "二头",
    "动作名称": "站姿哑铃弯举",
    "核心动作要领（含颈椎保护）": "大臂贴身体，手腕中立，颈椎保持正直，慢起慢落",
    "关键备注": "不借力甩动",
    "组数": 4,
    "次数（每组建议次数）": "10～12",
    "休息": "休 40 秒"
  },
  {
    ...
    "训练部位": "背",
    "动作名称": "龙门架坐姿划船",
    "核心动作要领（含颈椎保护）": "挺胸收腹，颈椎中立，拉至下腹，肩胛后收",
    "关键备注": "背部主导不耸肩",
    "组数": 4,
    "次数（每组建议次数）": "10～12",
    "休息": "直接做 B2"
  },
  {
    ...
    "训练部位": "二头",
    "动作名称": "绳索弯举",
    "核心动作要领（含颈椎保护）": "大臂固定，手腕中立，颈椎正直，顶峰收缩",
    "关键备注": "绳索弯举",
    "组数": 4,
    "次数（每组建议次数）": "12～15",
    "休息": "休 40 秒"
  },
  {
    ...
    "训练部位": "背",
    "动作名称": "单臂哑铃划船",
    "核心动作要领（含颈椎保护）": "一手支撑，腰背平直，颈椎中立，拉至腰侧",
    "关键备注": "10～12 / 侧",
    "组数": 3,
    "次数（每组建议次数）": "10～12 / 侧",
    "休息": "直接做 C2"
  },
  {
    ...
    "训练部位": "二头",
    "动作名称": "哑铃锤式弯举",
    "核心动作要领（含颈椎保护）": "拳眼向前，大臂固定，颈椎中立，不借力甩动",
    "关键备注": "侧重肱桡肌",
    "组数": 3,
    "次数（每组建议次数）": "10～12",
    "休息": "休 40 秒"
  },
  {
    ...
    "训练部位": "背",
    "动作名称": "直臂绳索下拉",
    "核心动作要领（含颈椎保护）": "直臂微屈，腰背稳定，颈椎中立，向下压至大腿",
    "关键备注": "龙门架直臂下拉",
    "组数": 3,
    "次数（每组建议次数）": "12～15",
    "休息": "休 40 秒"
  },
  {
    ...
    "训练部位": "腿",
    "动作名称": "史密斯深蹲",
    "核心动作要领（含颈椎保护）": "挺胸直背，颈椎中立，下蹲至大腿平行，膝盖与脚尖同向",
    "关键备注": "腿部大重量",
    "组数": 4,
    "次数（每组建议次数）": "10～12",
    "休息": "直接做 A2"
  },
  {
    ...
    "训练部位": "肩",
    "动作名称": "哑铃坐姿推举",
    "核心动作要领（含颈椎保护）": "坐直靠紧靠背，颈椎中立不仰头，推起不锁肘",
    "关键备注": "推举主练肩前中束",
    "组数": 4,
    "次数（每组建议次数）": "10～12",
    "休息": "休 60 秒"
  },
  {
    ...
    "训练部位": "腿",
    "动作名称": "史密斯箭步蹲",
    "核心动作要领（含颈椎保护）": "腰背直立，颈椎中立，前后腿下蹲 90°，重心居中",
    "关键备注": "10～12 / 腿",
    "组数": 3,
    "次数（每组建议次数）": "10～12 / 腿",
    "休息": "直接做 B2"
  },
  {
    ...
    "训练部位": "肩",
    "动作名称": "哑铃侧平举",
    "核心动作要领（含颈椎保护）": "微屈肘，颈椎中立，抬至与肩平，慢放不耸肩",
    "关键备注": "侧束塑形",
    "组数": 3,
    "次数（每组建议次数）": "12～15",
    "休息": "休 40 秒"
  },
  {
    ...
    "训练部位": "腿",
    "动作名称": "哑铃罗马尼亚硬拉",
    "核心动作要领（含颈椎保护）": "髋铰链，背平直，颈椎中立，下放至小腿中下段",
    "关键备注": "腘绳肌为主",
    "组数": 4,
    "次数（每组建议次数）": "10～12",
    "休息": "直接做 C2"
  },
  {
    ...
    "训练部位": "肩",
    "动作名称": "哑铃俯身飞鸟",
    "核心动作要领（含颈椎保护）": "俯身 45°，背平直，颈椎中立，微屈肘后展",
    "关键备注": "后束塑形",
    "组数": 4,
    "次数（每组建议次数）": "12～15",
    "休息": "休 40 秒"
  },
  {
    ...
    "训练部位": "肩",
    "动作名称": "哑铃前平举",
    "核心动作要领（含颈椎保护）": "肘微屈，颈椎中立，抬至肩高，控制下放",
    "关键备注": "前束训练",
    "组数": 3,
    "次数（每组建议次数）": "12～15",
    "休息": "休 40 秒"
  },
  {
    ...
    "训练部位": "腿",
    "动作名称": "站姿哑铃提踵",
    "核心动作要领（含颈椎保护）": "站姿稳定，颈椎中立，踮顶顶峰停顿，慢放",
    "关键备注": "小腿训练",
    "组数": 4,
    "次数（每组建议次数）": "15～20",
    "休息": "休 30 秒"
